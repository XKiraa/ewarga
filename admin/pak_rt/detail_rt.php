    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
		...
		<?php 
			...
			$sql = "SELECT * FROM d_pakrt where id_pakrt='$id_pakrt'" ;
			$query = mysqli_query($db, $sql);

			$no = 1;

			while ($dpakrt = mysqli_fetch_array($query)){
			?>
            ...
            <div class="container-fluid">
                ...
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Detail Data RT</a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
					...
					<div class=" col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Bapak <?php echo $dpakrt['nama']; ?></h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" value="<?php echo $dpakrt['kode_alamat']; ?>">
                                            </div>
                                            <label class="col-sm-3 col-form-label">No Telepon</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" value="<?php echo $dpakrt['no_telp']; ?>">
                                            </div>
                                            <label class="col-sm-3 col-form-label">Jenis Kelamin</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" value="<?php echo $dpakrt['jenis_kelamin']; ?>">
                                            </div>
                                            <label class="col-sm-3 col-form-label">Username</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" value="<?php echo $dpakrt['username']; ?>">
                                            </div>
