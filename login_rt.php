			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						<br><br><br>
		      	<h3 class="mb-4 text-center">Selamat Datang Pak RT</h3>

		      	<form action="cek_loginrt.php" method="POST" class="signin-form">
	          ...
	          <div class="social d-flex text-center">
	          	<a href="regis_rt.php" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-facebook mr-2"></span>Daftar</a>
	          </div> -->
			  <div class="social d-flex text-center">
	          	<a href="login.php" class="px-2 py-2 mr-md-1 rounded">Halaman Warga</a>
		      </div>
		      </div>
				</div>
			</div>
