                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    $query = mysqli_query($db, "SELECT RIGHT(id_kontak,6) as kode FROM kontak
                                                                            ORDER BY id_kontak DESC LIMIT 1")
                                        or die('Ada kesalahan pada query tampil id_kontak : ' . mysqli_error($db));
                                    ...
                                    $id_kontak = "USR-$buat_id";
                                    ?>


                                    <div class="form-group">
                                        <label for="id_kontak" class="text-black font-w500">ID Kontak</label>
                                        <input type="text" name="id_kontak" class="form-control" value="<?php echo $id_kontak; ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="no_telp" class="text-black font-w500">Telepon</label>
                                        <input type="number" name="no_telp" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="email" class="text-black font-w500">Email</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="edit.php?id_kontak=<?php echo $kontak['id_kontak']; ?>">Edit</a>
                                                                <a class="dropdown-item" href="hapus.php?id_kontak=<?php echo $kontak['id_kontak']; ?>" onClick="return confirm('Anda yakin akan menghapus akun<?php echo $kontak['judul']; ?>?');">Delete</a>
                                                            </div>
                                                        </div>
