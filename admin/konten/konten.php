				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="konten.php">Artikel</a></li>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
                            ...
                            <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        $query = mysqli_query($db, "SELECT RIGHT(id_konten,6) as kode FROM konten
                                                                            ORDER BY id_konten DESC LIMIT 1")
                                                                            or die('Ada kesalahan pada query tampil id_konten : '.mysqli_error($db));
                                        ...
                                        $id_konten = "USR-$buat_id";
                                        ?>


                                    <div class="form-group">
										<label for="id_konten" class="text-black font-w500" >ID Konten</label>
										<input type="text" name="id_konten" class="form-control" value="<?php echo $id_konten; ?>" readonly>
									</div>
									<div class="form-group">
                                    ...
                                    <div class="form-group">
										<label for="gambar" class="text-black font-w500" >Foto</label>
                                    ...
                                    <table id="example4" class="display min-w850">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><img src="gambar/<?php echo $konten['gambar']; ?>" style="width: 50px;"></td>
                                                ...
                                                <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="edit.php?id_konten=<?php echo $konten['id_konten']; ?>">Edit</a>
                                                                <a class="dropdown-item" href="hapus.php?id_konten=<?php echo $konten['id_konten']; ?>" onClick="return confirm('Anda yakin akan menghapus akun<?php echo $konten['judul']; ?>?');">Delete</a>
                                                            </div>
                                                        </div>
                                                </td>
                                            </tr>
