                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="id_about" value="<?php echo $about['id_about']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="deskripsi" value="<?php echo $about['deskripsi']; ?>" >
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                    <img src="gambar/<?php echo $about['gambar']; ?>" style="width: 100px;float: right;margin-bottom: 5px;">
