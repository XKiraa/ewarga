                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="proses_edit.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                        <input type="text" class="form-control" name="id_kontak" value="<?php echo $kontak['id_kontak']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-email">Judul 
                                                    </label>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control"  name="judul" value="<?php echo $kontak['judul']; ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-email">Deskripsi 
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="deskripsi" value="<?php echo $kontak['deskripsi']; ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="no_telp" value="<?php echo $kontak['no_telp']; ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="email" value="<?php echo $kontak['email']; ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
