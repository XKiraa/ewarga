                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="hapus.php?id_penduduk=<?php echo $warga['id_penduduk']; ?>" class="btn btn-danger shadow btn-xs sharp" onClick="return confirm('Anda yakin akan menghapus akun <?php echo $pakrt['nama']; ?> ?');"><i class="fa fa-trash"></i></a>
