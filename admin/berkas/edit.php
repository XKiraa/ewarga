...
if (isset($_GET['id_berkas'])) {
    ...
    $brk = mysqli_fetch_assoc($result); 
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($brk)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='data_berkas.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='data_berkas.php';</script>";
  }         
  ?>
            ...
            <!-- <a href="javascript:void(0)" class="add-menu-sidebar" data-toggle="modal" data-target="#addOrderModalside" >Tambah</a> -->
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Data Sipil</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="../pak_rt/data_rt.php">Data Pak RT</a></li>
                            <li><a href="../warga/data_warga.php">Data Warga</a></li>
                            <li><a href="data_berkas.php">Data Berkas</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="id_berkas" value="<?php echo $brk['id_berkas']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="nik" value="<?php echo $brk['nik']; ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="nama_berkas" value="<?php echo $brk['nama_berkas']; ?>" >
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <?php $brk ['status']; ?>
                                                        ...
                                                        <?php  echo"<option value=\"$brk[status]\"> $brk[status] </option>";?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="keterangan" value="<?php echo $brk['keterangan']; ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                    <img src="gambar/<?php echo $brk['file']; ?>" style="width: 100px;float: right;margin-bottom: 5px;">
