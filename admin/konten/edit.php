                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="id_konten" value="<?php echo $konten['id_konten']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="judul" value="<?php echo $konten['judul']; ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="deskripsi" value="<?php echo $konten['deskripsi']; ?>" >
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                    <img src="gambar/<?php echo $konten['gambar']; ?>" style="width: 100px;float: right;margin-bottom: 5px;">
